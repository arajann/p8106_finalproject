...
```{r}
pred.svml <- predict(svml.fit, newdata = testData_pp)
pred.svmr <- predict(svmr.fit, newdata = testData_pp)
pred.mars <- predict(mars.fit, newdata = testData_pp)

roc.gbmA <- roc(testData_pp, gbmA.pred)
roc.svml <- roc(testData_pp,pred.svml)
roc.svmr <- roc(testData_pp,pred.svmr)
roc.mars <- roc(testData_pp,pred.mars)
