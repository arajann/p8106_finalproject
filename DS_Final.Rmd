...
confusionMatrix(data=test.pred,
                ...
                positive = "Yes")
```
From the confusion matrix we have a 95.14% accuracy, and thus a testing error rate of 4.86%. We see that our model is not able to actually detect stroke cases at a 50% threshold. We should consult with experts on stroke to determine what threshold to use.
