...
```{r}
pred.svml <- predict(svml.fit, newdata = trainingData_pp)
pred.svmr <- predict(svmr.fit, newdata = trainingData_pp)
pred.mars <- predict(mars.fit, newdata = trainingData_pp)

roc.gbmA <- roc(trainingData_pp, gbmA.pred)
roc.svml <- roc(trainingData_pp,pred.svml)
roc.svmr <- roc(trainingData_pp,pred.svmr)
roc.mars <- roc(trainingData_pp,pred.mars)
